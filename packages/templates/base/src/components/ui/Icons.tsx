...
/**
 * Hand-crafted SVG icon set. All 24×24, stroke-based, scale via className.
 * Use like: <PlusIcon className="w-6 h-6" />
 *
 * Default size is w-6 h-6 (24px). Override via className when needed.
 */
