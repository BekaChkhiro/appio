...
export default function App() {
  ...
  const pages: Record<string, React.ReactNode> = {
    "/": <div id="page-home">/* Dashboard with balance + recent transactions */</div>,
    "/add": <div id="page-add">/* Add transaction form */</div>,
    "/stats": <div id="page-stats">/* Charts and category breakdown */</div>,
    "/history": <div id="page-history">/* Full transaction history */</div>,
  };
